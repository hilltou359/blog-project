...
namespace WeBlog.Data.Migrations
{
    ...
    [Migration("20230807051042_001_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WeBlog.Models.Blog", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("WeBlog.Models.BlogUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("WeBlog.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("WeBlog.Models.BlogUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("WeBlog.Models.Post", b =>
                {
                    b.HasOne("WeBlog.Models.Blog", "Blog")
                        .WithMany("Posts")
